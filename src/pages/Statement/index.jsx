        ...
        <div className="px-6 py-2.5 mx-auto w-full max-w-5xl text-gray-900 dark:text-gray-100 leading-6">
          <div className="mb-8">
            ...
            <p className="mb-1.5">
              ...
              có các điều khoản của riêng họ. Nếu bạn nhấp vào liên kết đến các
              trang web và ứng dụng không phải của Trung tâm GDNN-GDTX huyện
              Vĩnh Cửu, bạn nên đọc các điều khoản được hiển thị trên trang web
              của họ
            </p>
          </div>
          <div className="mb-8">
          ...
          <div className="mb-8">
            ...
            <p className="mb-1.5">
              ...
              hạn đến tất cả các thông tin, dữ liệu, văn bản, phần mềm, âm nhạc,
              âm thanh, hình ảnh, đồ họa, video, thông điệp hoặc các nguyên liệu
              khác (“Nội dung”) mà bạn đã chia sẻ cho chúng tôi.
            </p>
            <p className="mb-1.5">
          ...
          <div className="mb-8">
            ...
            <p className="mb-1.5">
              ...
              chúng tôi không bị tổn hại bởi bất kỳ khiếu nại, khiếu kiện, chi
              phí, tổn thất, thiệt hại, phán quyết của tòa án và phí tổn nào,
              bao gồm nhưng không giới hạn phí luật sư, phí bồi thường thiệt
              hại, chi phí tố tụng, lãi chậm trả liên quan đến hoặc phát sinh từ
              bất kỳ khiếu nại, mâu thuẫn, tranh chấp, thủ tục tố tụng pháp lý
              tại Tòa án hoặc các tổ chức Trọng tài, tổ chức Hòa giải, các quyết
