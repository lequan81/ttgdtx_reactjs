    ...
    <section className="flex flex-col flex-grow h-full items-center justify-start bg-gray-100 dark:bg-gray-900 w-full mt-12">
      ...
      {isDone.show === true ? (
        <form
          ...
          className="shadow-md transition-shadow shadow-gray-300 dark:shadow-none sm:rounded px-8 mx-auto sm:mt-8 sm:mb-8 sm:py-8 py-4 mt-4 mb-32 bg-white dark:bg-gray-800 border border-gray-200 dark:border-none flex flex-col w-full max-w-4xl"
        >
        ...
        <div className="flex items-center mt-6 text-center border rounded-lg h-fit sm:w-full w-3/4 mx-auto sm:mx-0 max-w-md dark:border-gray-700">
          <div className="flex flex-col w-full px-4 sm:py-8 py-4 mx-auto">
            <div
              className={`sm:p-3 p-2 mx-auto rounded-full dark:bg-gray-800 ${
                isDone.success
