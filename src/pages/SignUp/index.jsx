      ...
      <div className="shadow-md transition-shadow shadow-gray-400 dark:shadow-none rounded px-8 mx-auto my-8 py-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-none flex flex-col w-full max-w-4xl">
        ...
        <div className="md:flex mb-6">
          ...
          <div className="md:w-1/4 px-3">
            ...
            <select className="appearance-none placeholder:text-gray-500 dark:placeholder:text-gray-400 block w-full mt-1 bg-gray-100 dark:bg-gray-800 bg-opacity-50 rounded-sm border border-gray-300 dark:border-gray-700 focus:ring-1 focus:ring-blue-500 text-base outline-none text-gray-700 dark:text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
