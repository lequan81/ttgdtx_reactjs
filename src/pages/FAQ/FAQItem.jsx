...
function FAQItem({ ques, ans, isLink, href, linkTitle }) {
  return (
    <div className="p-4 last:mb-4 bg-white hover:bg-gray-50 transition-all dark:bg-gray-800 dark:hover:bg-gray-700/70 rounded-md border border-gray-200 dark:border-gray-800 animate__animated animate__fadeIn animate__fast">
