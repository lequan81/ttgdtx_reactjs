        ...
        <div className="px-6 py-2.5 mx-auto w-full max-w-5xl text-gray-900 dark:text-gray-100 leading-6">
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Thông tin về thiết bị của bạn (chẳng hạn như địa chỉ IP, là mã
                số để xác định thiết bị của bạn có thể cung cấp thông tin về
                quốc gia, khu vực hoặc thành phố nơi bạn ở)
              </li>
              <li>
            ...
            <p className="mb-1.5">
              ...
              có chính sách bảo mật của riêng họ. Nếu bạn nhấp vào liên kết đến
              các trang web và ứng dụng không phải của Trung tâm GDNN-GDTX huyện
              Vĩnh Cửu, bạn nên đọc chính sách bảo mật được hiển thị trên trang
              web của họ
            </p>
          </div>
          <div className="mb-8">
            ...
            <p className="mb-1.5">
              ...
              dụng dữ liệu cá nhân của bạn. Nếu bạn muốn liên hệ trực tiếp với
              chúng tôi, xin vui lòng liên lạc qua đường dây nóng 0975940054 để
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Dữ liệu cá nhân chúng tôi tạo ra về bạn, ví dụ: dữ liệu cá nhân
                mà chúng tôi sử dụng để xác thực bạn hoặc dữ liệu cá nhân ở dạng
                địa chỉ IP của bạn hoặc tùy chọn của bạn
              </li>
              <li>
                Dữ liệu cá nhân mà chúng tôi thu thập từ các bên thứ ba, ví dụ:
          ...
          <div className="mb-8">
            ...
            <p className="mb-1.5">
              ...
              lý dựa trên các mục đích mà chúng tôi đã thu thập dữ liệu cá nhân
              của bạn.
            </p>
          </div>
          <div className="mb-8">
          ...
          <div className="mb-2">
            ...
            <p className="mb-1.5">
              ...
              đã đăng ký của chúng tôi với các chi tiết mới
            </p>
