  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-6 pb-3 md:pb-2 md:pt-4 md:px-2.5 flex flex-col">
        ...
        <p className="mb-4 h-24 sm:h-20 text-gray-700 dark:text-gray-300 line-clamp-4 md:text-sm text-base">
        ...
        <div className="flex flex-row w-full mt-1 text-xs font-semibold uppercase gap-x-12 justify-between lg:gap-x-6 lg:mb-2">
          <p className="flex flex-grow justify-start transition-colors duration-200 text-blue-600 dark:text-blue-400 hover:text-blue-600">
            {hashtag || "other"}
          </p>
          <span className="text-gray-700 dark:text-gray-400 justify-end text-xs">
