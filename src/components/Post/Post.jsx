  ...
  return (
    ...
    >
      <img
        ...
        loading="lazy"
        className="object-cover aspect-video w-full xl:h-52 lg:h-40 md:h-36 h-52 opacity-95 bg-center bg-no-repeat bg-cover group-hover:opacity-100 transition-opacity transform duration-200"
        alt={title || "Title"}
      />
